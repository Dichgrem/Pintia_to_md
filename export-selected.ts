...
async function getSessionId(): Promise<string> {
  ...
  console.log("4. 刷新页面");
  console.log("5. 找到任意请求，查看 Request Headers 中的 Cookie: PTASession=xxx");
...
async function exportProblemSets(selectedSets: any[]) {
  ...
  for (let i = 0; i < selectedSets.length; i++) {
    ...
    console.log(`\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    console.log(`[${i + 1}/${selectedSets.length}] 处理题目集: ${problemSetName}`);
    console.log(`━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`);
    ...
    try {
      ...
      if (!(submissionsInfo instanceof Error) && submissionsInfo?.submissions?.length > 0) {
        ...
        for (let j = 0; j < acceptedSubmissions.length; j++) {
          ...
          process.stdout.write(`\r   进度: ${j + 1}/${acceptedSubmissions.length}`);
    ...
    console.log(`   ⏭️  未作答: ${allProblems.length - Object.keys(userAnswers).length}`);
